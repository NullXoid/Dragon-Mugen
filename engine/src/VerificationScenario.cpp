...
int runNamedScenario(RuntimeProbe& runtime, std::string_view scenarioName, std::ostream& out) {
    ...
    if (scenarioName == "video-resolution-presentation-e2e") return runVideoResolutionPresentationE2e(runtime, out);
