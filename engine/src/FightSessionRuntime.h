...
void clearFighterVisualRuntime(FighterState& fighter) {
    fighter.paletteEffect = {};
    fighter.afterImage = {};
    fighter.transEffect = {};
...
void resetTrainingPositions(AppState& state) {
    ...
    state.fighters[0].arenaDepthModifierHeld = false;
    state.fighters[0].arenaDepthModifierLastTapFrame = -100000;
    state.fighters[0].arenaDepthSidestepTicks = 0;
    state.fighters[0].arenaDepthSidestepVelocity = 0.0f;
    state.fighters[0].arenaDepthSidestepDirection = 1;
    ...
    state.fighters[1].arenaDepthModifierHeld = false;
    state.fighters[1].arenaDepthModifierLastTapFrame = -100000;
    state.fighters[1].arenaDepthSidestepTicks = 0;
    state.fighters[1].arenaDepthSidestepVelocity = 0.0f;
    state.fighters[1].arenaDepthSidestepDirection = 1;
    ...
    clearFighterVisualRuntime(state.fighters[0]);
