...
inline constexpr int kTrainingOptionCount = 21;
inline constexpr int kTrainingOptionRows = 11;
inline constexpr int kTrainingMoveListRows = 10;
inline constexpr int kTrainingExitMainOption = 9;
...
inline constexpr int kTrainingAutoLifeOption = 20;
