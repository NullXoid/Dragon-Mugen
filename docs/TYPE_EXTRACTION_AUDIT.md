...
| Item | Estimate |
| --- | ---: |
| Current `App.cpp` count | 14495 after Pass 20 |
| Known extracted headers/modules | 23 extracted headers/modules, including normal `TrainingState.h` / `FightMessageState.h` and transitional `FrontendFlow.h` / UI render helper headers |
