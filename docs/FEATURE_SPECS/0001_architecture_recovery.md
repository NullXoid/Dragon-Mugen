...
- [x] Add an end-to-end SDL presentation verifier for all five output profiles, including Video Options row-model and rendered-menu consistency, and run it from the full development gate.
